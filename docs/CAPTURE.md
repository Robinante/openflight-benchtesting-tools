...
```powershell
Set-Location path\to\OpenFlight-Radar-Workbench
py -m venv .venv
.\.venv\Scripts\python.exe -m pip install -e .
.\.venv\Scripts\python.exe -m openflight_bench --port COM7 --baud 1041667 --out-dir .\captures
```
...
- [Raspberry Pi UART baseline](PI_UART_BASELINE_2026-09-14.md)
- [Windows vs. Raspberry Pi UART investigation](WINDOWS_VS_PI_UART_REPORT_2026-09-14.md)
- [Interactive Pi capture analysis](reports/pi-uart-baseline-2026-09-14/index.html)
- [UART reader diagnostics and wire preservation](UART_READER_FIX.md)
- [Proposed ILD1 CRC and dump-sequence scope](ILD1_V8_INTEGRITY_SCOPE.md)
- [Initial raw-dump follow-up](OpenFlight_Raw_Dump_Followup.md)
...
with the existing `analyze_material.py` and `analyze_sweep.py`. Those entry points now call the shared `openflight_bench.analysis` package.
See the [analysis guide](ANALYSIS.md) for command-line and Python usage.

## Development

See the [repository README](../README.md#development) for installation and tests.
